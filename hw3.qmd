...
pal_palette <- c("#6A0304", "#F02224", "#F85550","#5F8A80", "#B5CEA7", "#ABAE39", "#4C4A21", "#312C16")
names(pal_palette) <- nri_race_summary$race_ethnicity
# -----------------------------
# Set fonts 
# -----------------------------
...
ggplot(nri_race_summary, aes(x = as.factor(id), y = total_weighted_nri, fill = race_ethnicity)) +
  ...
  scale_fill_manual(values = pal_palette) +
  coord_polar(start = 0) +
