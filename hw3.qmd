...
-   **4.** What modifications did you make to this visualization to make it more easily readable?
    ...
    -   margins, font size, reordered categories in descending nri index value, adjusted color palette

-   **5.** Is there anything you wanted to implement, but didn’t know how? If so, please describe.

    -   i didn't know how to make the circle plot bigger i worked with y lim, plot margins, save ggplot margins
